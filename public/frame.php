...
define('version','official-w3010-12/22/2014');
...
switch($action) {
	...
	case "createflight":
		if(check_session($_GET['dbid'], $_GET['sessionid']) == true) {
			$ret = smartCARS::createflight($_GET['dbid'], $_GET['code'],$_GET['flightnumber'],$_GET['departureicao'], $_GET['arrivalicao'],$_GET['aircraft'], $_GET['flighttype'], $_GET['departuretime'], $_GET['arrivaltime'], $_GET['flighttime'], $_POST['route'], $_GET['cruisealtitude'], $_GET['distance']);
			if($ret == true)
				echo("SUCCESS");
			else
				echo("ERROR");
